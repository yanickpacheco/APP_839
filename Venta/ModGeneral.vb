...
Module ModGeneral
    ...
    Public vgListRestriccionPlan As New List(Of eRestriccion)
    ...
    Public Const csNombreAplicacion As String = "ONCOLÓGICO FULL SCOTIABANK"
    ...
    Public Const CENTRODECOSTO As String = "828"
